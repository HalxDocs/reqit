  ...
  if (!username || typeof username !== "string") {
    return res.status(400).json({
      ...
      usage: {
        ...
        example: "https://reqit.vercel.app/api/v1/profile/johndoe",
      },
      ...
      integrations: {
        ...
        nextjs: "export async function getServerSideProps() { const res = await fetch('https://reqit.vercel.app/api/v1/profile/yourname'); return { props: { profile: await res.json() } } }",
      },
    });
  }
