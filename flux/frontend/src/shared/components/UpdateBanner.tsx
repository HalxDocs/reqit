import { Download, X, ArrowUpCircle, CheckCircle2, AlertCircle, Loader2, RotateCcw } from "lucide-react";
import { useUpdater } from "@/app/hooks/useUpdater";
import { Button } from "./Button";
import { IconButton } from "./IconButton";

export function UpdateBanner() {
  const { update, installing, done, error, install, restart, dismiss } = useUpdater();
